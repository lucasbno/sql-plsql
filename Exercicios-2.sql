...
---------------------------------------------------------
-- tb_pais(id_pais, nm_pais, id_regiao)
...
SELECT * FROM tb_pais;
SELECT COUNT(*) FROM tb_pais;

---------------------------------------------------------
--tb_localizacao (id_localizacao, id_pais, endereço, cep, cidade, estado)

INSERT INTO tb_localizacao
VALUES (1000, 'IT', 'Via Cola di Rie, 1297', '00989', 'Roma', NULL);

INSERT INTO tb_localizacao
VALUES (1100, 'IT', 'Calle della Tesla, 93091', '10934', 'Veneza', NULL);
...
INSERT INTO tb_localizacao
VALUES (2600, 'UK', 'Chester Road, 9702', '09629850293', 'Stretfod', 'Manchester');
...
---------------------------------------------------------
--tb_departamento (id_departamento, nm_departamento, id_gerente, id_localizacao )
...
---------------------------------------------------------
--tb_funcao (id_funcao, ds_funcao, base_salario, teto_salario)

INSERT INTO tb_funcao
VALUES ('AD_PRES', 'Presidente', 20000, 40000);

INSERT INTO tb_funcao
VALUES ('AD_VP', 'Vice Presidente', 15000, 30000);
...
INSERT INTO tb_funcao
VALUES ('PR_REP', 'Representante d Relações Pública', 4500, 10500);
...
-- tb_empregado(
    -- id_empregado, nome, sobrenome, email, telefone,
    -- data_admissao,
    -- id_funcao, salario, percentual_comissao, id_gerente, id_departamento
-- )
...
INSERT INTO tb_empregado
VALUES (
  112, 'Jose Manuel', 'Urman', 'JURMAN', '515.124.4567',
...
VALUES (
  ...
  TO_DATE('07-DEC-199', 'dd-MON-yyyy'),
  'FI_ACCOUNT', 6900.00, NULL, 108, 100
);
...
INSERT INTO tb_empregado
VALUES (
  116, 'Shelli', 'Baida', 'SBAIA', '515.127.4563',
...
INSERT INTO tb_empregado
VALUES (
  126, 'Irene', 'Mikkilinenil', 'IMIKKILI', '650.124.1224',
...
INSERT INTO tb_empregado
VALUES (
  145, 'John', 'Russell', 'JRUSSEL', '011.44.1344.428268',
...
VALUES (
  ...
  TO_DATE('21-JUN-199', 'dd-MON-yyyy'),
  'SH_CLERK', 2500.00, NULL, 120, 50
);

INSERT INTO tb_empregado
VALUES (
  183, 'Ginard', 'Geoni', 'GGEONI', '650.507.9879',
...
INSERT INTO tb_empregado
VALUES (
  191, 'Randall', 'Perkins', 'RPERKINS', '650.505.4976',
...
INSERT INTO tb_empregado
VALUES (
  197, 'Kevin', 'Freeney', 'KFEENEY', '650.507.9822',
...
INSERT INTO tb_empregado
VALUES (
  199, 'Douglas', 'Grant', 'GRANT', '650.507.9844',
...
ALTER TABLE tb_departamento ENABLE CONSTRAINT fk_gerente_depto;
